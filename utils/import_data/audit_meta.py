...
MUSEUM_NOTE = {
    ...
    "mfa_boston_ext": "本清单 4464 件，来源分两类且性质差别很大：135 件出自 MFA 官网"
                      ...
                      "不要因为同属一份清单就一视同仁。",
    # 用户 2026-09-24 审定。数量与来源随 wmhg_build.py 的产出，**源表一变这里要跟着改**
    "wmhg": "本馆 61 条分四批，来源性质不同，请按每件实际列出的来源判断。"
            "① 30 件藏品出自官网「藏品」栏目（中文 29 件，另 1 件只有英文版），是馆方发布的"
            "精选介绍，多数写明尺寸与年代，但没有馆藏号，也不写是否在展；英文版为馆方机翻，"
            "与中文不一致时以中文为准。"
            "② 4 件出自 2026-01-20 官网文章，写明在怀远楼二楼清宴堂的御纹章展展出。"
            "③ 17 个节点出自官网常设展览栏目与上述文章。"
            "④ 10 个节点只出自 2023 年馆方导览，每个只有一两句介绍，现状未核实。"
            "本馆在国家文物局「博物中国」与 Wikidata 上都没有藏品条目。",
